@EndUserText.label: 'Sales Invoicing GST'
@AccessControl.authorizationCheck: #MANDATORY
@Metadata.allowExtensions: true
define view entity ZI_SalesInvoicingGst
  as select from ZDT_SALESINV
  association to parent ZI_SalesInvoicingGst_S as _SalesInvoicingGsAll on $projection.SingletonID = _SalesInvoicingGsAll.SingletonID
